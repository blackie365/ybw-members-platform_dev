        ...
        <div className="mx-auto w-full max-w-lg">
          ...
          <SignIn 
            ...
            appearance={{
              ...
              elements: {
                rootBox: 'shadow-none w-full border-none bg-transparent cl-internal-ml9k5m',
                card: 'shadow-none border-none bg-transparent w-full max-w-none p-0 sm:p-0',
                navbar: 'hidden',
                header: 'block mb-8',
                headerTitle: 'font-serif text-2xl text-stone-900 font-medium tracking-tight',
                headerSubtitle: 'text-stone-500 text-sm leading-relaxed mt-1',
