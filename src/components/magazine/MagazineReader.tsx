  ...
  <div className="h-full w-full relative overflow-hidden bg-zinc-900">
    ...
    <div className="absolute bottom-[10%] left-[8%] right-[8%] max-w-5xl">
      ...
      >
        ...
        <div className="text-white/90 text-[clamp(0.85rem,1.8vh,1.3rem)] font-light max-w-2xl border-l-4 border-accent pl-[4%] line-clamp-3 sm:line-clamp-none leading-relaxed drop-shadow-md [&_p]:m-0 [&_p]:inline [&_strong]:font-semibold [&_em]:italic [&_a]:underline [&_a]:underline-offset-2">
    ...
    <div className="min-h-full w-full relative bg-[#FAF9F6] flex flex-col lg:block pb-[15vh] overflow-visible">
      ...
      <div className="relative h-full w-full p-[8%] flex flex-col justify-start lg:justify-center z-10 min-h-0 pt-[12%] lg:pt-[8%]">
        <div className="max-w-[min(100%,500px)] lg:max-w-[42%] pr-[4%]">
          ...
          <h2 className="text-[clamp(2rem,8vh,4.5rem)] font-serif mb-[4%] tracking-tighter leading-[0.85]">
            {titleLines.length > 0 ? (
    ...
    <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center gap-[8%] lg:gap-[10%] w-full min-h-0">
      ...
      <div className="text-center lg:text-left py-[4%] flex-1 pr-[4%]">
        ...
        <div className="relative mb-[6%]">
          ...
          <div className="text-[clamp(1rem,2.5vh,1.8rem)] text-zinc-600 leading-relaxed font-light italic border-l-4 border-accent/20 pl-[5%] relative z-10 [&_p]:m-0 [&_p]:inline [&_strong]:font-semibold [&_em]:italic [&_a]:underline [&_a]:underline-offset-2 before:content-['“'] after:content-['”']">
