      ...
      <Dialog open={open} onOpenChange={(next) => !next && handleDismiss()}>
        <DialogPortal>
          ...
          <DialogPrimitive.Content
            ...
            className={cn(
              "fixed hidden lg:grid left-1/2 top-1/2 w-full max-w-[360px] -translate-x-1/2 -translate-y-1/2 p-0 gap-0 rounded-2xl outline-none focus:outline-none",
      ...
      >
        <DrawerPortal>
          ...
          <DrawerPrimitive.Content
            className={cn(
              "lg:hidden bg-white fixed flex h-auto flex-col outline-none focus:outline-none",
