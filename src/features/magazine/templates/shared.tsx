...
function PullQuoteCard({
  ...
  const textClassName =
    variant === "dark" ? "text-white/85" : "text-[#3d2b1f]/85";
  const floatClassName =
    align === "right" ? "md:float-right md:ml-6" : "md:float-left md:mr-6";
  ...
  return (
    ...
    >
      <div
        className={[
          "absolute -top-9 -left-4 font-serif leading-none select-none",
          accentClassName,
        ].join(" ")}
      ...
      <div
        className="mt-5 h-px w-14 bg-[#a3413a]"
...
function MediaFigure({
  ...
  return (
    <figure
      className={[
        "rounded-3xl overflow-hidden shadow-[0_20px_90px_rgba(0,0,0,0.14)]",
        frameClassName,
        outerClassName,
      ].join(" ")}
    >
      <div className={["relative", ratioClassName].join(" ")}>
        ...
        <div
          className={
            variant === "dark"
              ? "absolute inset-0 bg-gradient-to-t from-black/35 via-transparent to-transparent"
      ...
      {item.caption ? (
        <figcaption className="px-5 py-4">
          ...
          <p
            className={["text-sm leading-relaxed", captionClassName].join(" ")}
          >
            {item.caption}
          </p>
        </figcaption>
...
function InterleavedTextWithMedia({
  ...
  const safeMedia = Array.isArray(inlineMedia)
    ? inlineMedia.filter(Boolean)
    : [];
  const safeQuotes = Array.isArray(pullQuotes)
    ? pullQuotes.map((q) => String(q || "").trim()).filter(Boolean)
    : [];
  ...
  const qSpacing = Math.max(
    2,
    Math.floor(safeBlocks.length / (safeQuotes.length + 1)),
  );
  ...
  const mSpacing = Math.max(
    1,
    Math.floor(availableSlots.length / (safeMedia.length + 1)),
  );
  ...
  return (
    <div ref={ref} className="relative min-h-full overflow-hidden bg-[#0c0a09]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/4 left-1/4 w-[28rem] h-[28rem] rounded-full"
          style={{
            background:
              "radial-gradient(ellipse, rgba(163,65,58,0.25) 0%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(163,65,58,0.18) 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent, #a3413a 30%, #a3413a 70%, transparent)",
        }}
      />
        ...
        >
          ...
          {(data.headline || data.subheadline) && (
            <div className="cover-animate opacity-0 mb-7">
              <div className="inline-flex items-start gap-3 bg-white/[0.07] backdrop-blur-md border border-white/15 rounded-xl px-4 py-3.5 max-w-sm">
                <div
                  className="w-0.5 h-12 rounded-full flex-shrink-0 mt-0.5"
                  style={{
                    background: "linear-gradient(to bottom, #a3413a, #a3413a)",
                  }}
                />
          ...
          <div className="cover-animate opacity-0 flex items-center gap-3 flex-wrap">
            <Link
              ...
              style={{
                background: "linear-gradient(135deg, #a3413a 0%, #a3413a 100%)",
              }}
            >
              Browse Archive
...
export const PageEditorial = ({ data, imageVersion }: any) => {
  ...
  const introHtml =
    data.intro || (!data.intro && allBlocks.length > 1 ? allBlocks[0] : "");
  ...
  const signature =
    String(data.author || "")
      ...
      .split(/\s+/g)
      .filter(Boolean)[0] || "";
  const introWithDropcap = introHtml
    ? addClassToFirstParagraph(introHtml, "editorial-dropcap")
    : "";
  const additionalMedia = getAdditionalMedia(
    data,
    String(data.title || data.author || "Editorial").trim(),
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          <div className="lg:col-span-4 scroll-reveal scroll-reveal-delay-1">
            <div className="lg:sticky lg:top-32 space-y-5">
              ...
              <div className="rounded-xl p-5 border border-[#e8d5c0] bg-white shadow-sm">
                ...
                <p className="font-bold text-[#1c1410] text-lg">
                  {data.author}
                </p>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="scroll-reveal scroll-reveal-delay-2">
              <h2 className="text-feature-xl font-serif font-600 text-[#1c1410] mb-2">
            ...
            {textBlocks.length > 0 && (
              <div className="scroll-reveal scroll-reveal-delay-4">
                <InterleavedTextWithMedia
                  ...
                  pullQuotes={normalizePullQuotes(
            ...
            {signature && (
              <div className="scroll-reveal pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <p className="font-serif italic text-[#3d2b1f] font-medium text-lg">
                    With warmth and ambition,
                  </p>
                </div>
                <p className="font-bold text-[#a3413a] mt-3 text-lg">
                  {signature}
                </p>
              </div>
            )}
...
export const PageContents = ({ data, imageVersion }: any) => {
  ...
  return (
    <div
      ref={ref}
      className="bg-[#1a1210] py-16 lg:py-24 min-h-full text-white"
    >
      <div
        className="h-0.5 w-full mb-0"
        style={{
          background:
            "linear-gradient(90deg, transparent, #a3413a 30%, #a3413a 70%, transparent)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-10">
        <div className="scroll-reveal mb-12 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            {["Instagram", "LinkedIn", "X"].map((s) => (
              <span
                key={s}
                className="text-zinc-500 hover:text-[#a3413a] transition-colors text-xs font-medium cursor-pointer"
              >
                {s}
              </span>
            ))}
        ...
        {data.text && (
          <div className="scroll-reveal -mt-6 mb-10 max-w-3xl">
            <SafeText
              html={data.text}
              className="font-serif text-white/70 leading-relaxed"
            />
          </div>
        )}
                  ...
                  <div className="absolute top-0 right-0 w-12 h-12 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        borderTop: "48px solid rgba(163,65,58,0.08)",
                      }}
                    />
                  </div>
                  <div className="flex items-start justify-between mb-3">
                    <span className="text-[9px] font-bold uppercase tracking-[0.18em] text-[#a3413a]">
                      {item?.category}
                    </span>
                    <span className="text-3xl font-extrabold text-white/80 font-serif leading-none tabular-nums drop-shadow-sm group-hover:text-white transition-colors">
                      {pageLabel}
                    </span>
                  </div>
                  <p className="font-serif font-semibold text-white/90 text-base leading-snug flex-1">
                    {item?.title}
                  </p>
        ...
        {(news.length > 0 || showLiveNews) && (
          <div className="scroll-reveal rounded-xl border border-white/[0.07] bg-white/[0.03] p-6">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#a3413a] mb-4">
              {showLiveNews
                ? "Regional Women in Business News"
              ...
              <ul className="space-y-3">
                {liveNewsLoading && liveNews.length === 0 ? (
                  ...
                  liveNews.map((item: any, i: number) => (
                    ...
                    >
                      <span className="text-[#a3413a] mt-0.5 flex-shrink-0 text-[10px]">
                        ◆
                      </span>
                      <a
  ...
  return (
    <div ref={ref} className="bg-[#faf7f2] min-h-full flex flex-col">
      ...
      <div className="shrink-0 border-b border-[#a3413a]/15 bg-[#f4ede0] px-6 sm:px-10 lg:px-12 py-3.5 flex items-center gap-3">
        <span className="text-[#a3413a] text-sm" aria-hidden>
          ↳
        </span>
        ...
        {kicker && (
          <>
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-[#7a5c4e]">
              {kicker}
            </span>
          </>
        )}
        ...
        {author && (
          <span className="text-[10px] uppercase tracking-[0.2em] text-[#7a5c4e] shrink-0">
            {author}
          </span>
        )}
      </div>
      ...
      <div className="flex-1 px-6 sm:px-10 lg:px-12 py-12 lg:py-16">
        {allBlocks.length > 0 ? (
          ...
          <p className="font-serif text-[#7a6e65] italic">
      ...
      <div className="shrink-0 px-6 sm:px-10 lg:px-12 pb-8 flex items-center gap-3">
        ...
        <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#a3413a]">
          YBW
        </span>
      </div>
    </div>
...
export const PageFeatureLeft = ({ data, imageVersion }: any) => {
  ...
  return (
    <div
      ref={ref}
      className="relative flex flex-col lg:flex-row h-full min-h-full overflow-hidden"
    ...
    >
      <div className="relative w-full lg:w-1/2 h-56 sm:h-72 lg:h-full flex-shrink-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to right, transparent, #e8e0d5)",
          }}
        />
        <div
          className="absolute inset-x-0 bottom-0 h-16 lg:hidden"
          style={{
            background: "linear-gradient(to bottom, transparent, #e8e0d5)",
          }}
        />
      </div>
      ...
      <div className="relative flex flex-col justify-start flex-1 px-6 sm:px-10 lg:px-12 pt-10 pb-12 lg:pt-12 lg:pb-14 overflow-y-auto">
        ...
        />
        <div
          className="absolute top-0 left-0 bottom-0 w-1 hidden lg:block"
          style={{
            background:
              "linear-gradient(to bottom, transparent, #a3413a 20%, #a3413a 80%, transparent)",
          }}
        />
        ...
        {data.name && (
          <p
            className="scroll-reveal text-xs font-semibold uppercase tracking-widest mb-2"
            style={{ color: "#7a5c4e" }}
          >
            {data.name}
          </p>
        ...
        {data.title && (
          <h2
            className="scroll-reveal scroll-reveal-delay-1 font-serif font-bold leading-tight mb-5 text-[#1c1410]"
            ...
            {stats.slice(0, 3).map((stat: any, i: number) => (
              <div
                ...
                style={{
                  ...
                  borderColor: "rgba(163,65,58,0.18)",
                }}
              >
                <p
        ...
        <div className="scroll-reveal mt-8 pt-6 flex items-center gap-3">
          <div
            ...
            style={{
              background: "linear-gradient(to right, #a3413a, transparent)",
            }}
          />
          <span
          ...
          <div className="lg:col-span-6 scroll-reveal scroll-reveal-delay-2 space-y-4">
            ...
            {stats.length > 0 && (
              <div className="rounded-2xl border border-[#e8d5c0] bg-white shadow-sm p-6">
                {snapshotLabel && (
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#a3413a] mb-3">
                    {snapshotLabel}
                  </p>
                )}
                <div className="space-y-2.5">
                  {stats.map((stat: any, i: number) => (
                    <div
                      key={`${stat?.label ?? "stat"}-${i}`}
                      className="rounded-xl border border-[#f0e8da] bg-[#faf7f2] p-4 flex items-start gap-4"
                    >
                      <span className="font-serif font-bold text-[#a3413a] text-2xl shrink-0 w-16 text-center">
                        {stat?.value}
                      </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[42%_58%] min-h-full">
        ...
        <div className="relative flex flex-col justify-center px-8 py-12 lg:px-12 lg:py-16 xl:px-16 bg-[#0e0b09] overflow-y-auto">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse, #a3413a 0%, transparent 70%)",
              filter: "blur(80px)",
            }}
          />
          {data.name && (
            <div className="sticky top-0 z-20 -mx-8 lg:-mx-12 xl:-mx-16 px-8 lg:px-12 xl:px-16 py-5 bg-[#0e0b09]/85 backdrop-blur-md border-b border-white/[0.06]">
              ...
              <h2
                className="mt-3 font-serif text-white font-bold leading-tight tracking-tight"
                style={{ fontSize: "clamp(2rem, 4vw, 3.25rem)" }}
              >
...
export const PagePartner = ({ data, imageVersion }: any) => {
  ...
  return (
    <div
      ref={ref}
      className="relative py-16 lg:py-24 min-h-full overflow-hidden text-white"
      style={{
        background:
          "linear-gradient(135deg, #0f0a0d 0%, #1a0d14 40%, #0f0a0d 100%)",
      }}
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse, #a3413a 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6 scroll-reveal">
            ...
            {data.headline && (
              <p className="text-white/65 font-medium mt-1 text-lg">
                {data.headline}
              </p>
            )}
            {data.text ? (
